...
private void fragenHinzufuegen() {
	...
	// Ressourcen der Erde_______________________________________________________________________________________________________
		...
		fragen.add(new Question(
				"Welche der folgenden Energiequellen gehört nicht zu den erneuerbaren?",
				"Solarenergie", "Geothermie", "Wasserkraft", "Erdgas",
				'D',
				"https://www.umweltbundesamt.de/daten/energie/erneuerbare-konventionelle-stromerzeugung#bruttostromerzeugung-aus-nicht-erneuerbaren-energietragern-",
				Kategorie.KLIMAWANDEL_UND_ENERGIE
				));

		fragen.add(new Question(
				"Welcher Sektor verursacht weltweit am meisten CO2-Emmissionen?",
				"Verkehr (Autos, Schiffe, Flugzeuge,...)", "Industrie (Fabriken, Produktionen,...)", "Haushalte (Strom, Heizung,...)", "Landwirtschaft",
				'B',
