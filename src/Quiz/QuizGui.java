...
// Lange Antworttexte umbrechen, ohne das Layout zu verschieben
        Button[] answerButtons = {answerA, answerB, answerC, answerD};
        for (Button answerButton : answerButtons) {
                answerButton.setWrapText(true);
                answerButton.setTextAlignment(TextAlignment.LEFT);
                answerButton.setAlignment(Pos.CENTER_LEFT);
                answerButton.setPrefWidth(420);
                answerButton.setMaxWidth(420);
                answerButton.setMinHeight(Region.USE_PREF_SIZE);
        }
...
// Ansonsten wird automatisch angepasst wenn Platz ist
